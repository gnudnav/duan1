...
public class CTHD {
    ...
    public CTHD(int macthd, int masanpham, int mahd, int trangthai, int gia, String imgsanpham, String ten, String tenbrand, int maloai, int soluong, int trangthaicthd) {
        this.macthd = macthd;
